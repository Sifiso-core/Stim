...
public static class DependencyInjection
{
    public static WebApplicationBuilder AddAPICoreServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddApiVersioning(options =>
        {
            ...
            options.ApiVersionReader = ApiVersionReader.Combine(new MediaTypeApiVersionReader(), new MediaTypeApiVersionReaderBuilder()
                .Template("application/vnd.stim.hateoas.{version}+json")
                .Build());
        ...
        }).AddOpenApi(options =>
        {
            ...
            options.Document.AddOperationTransformer<BearerSecurityOperationTransformer>();
        });
    ...
    public static WebApplicationBuilder AddApplicationServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddScoped<IRepresentationContext, RepresentationContext>();
